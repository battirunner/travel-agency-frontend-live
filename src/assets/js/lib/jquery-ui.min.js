...
!(function (t) {
    ...
    return (
      ...
      p(a, function (t, e) {
        ...
        if (i)
          return (
            (i = n[e](i)),
            (n[u[e].cache] = i[u[e].cache]),
            (o = n._rgba = i._rgba),
            !1
          );
      }),
      o.length
        ? ("0,0,0,0" === o.join() && r.extend(o, I.transparent), n)
        : I[s]
    );
  }
  function n(t, e, i) {
  ...
  (s.style.cssText = "background-color:rgba(1,1,1,.5)"),
    (l.rgba = -1 < s.style.backgroundColor.indexOf("rgba")),
    p(u, function (t, e) {
      (e.cache = "_" + t),
                ...
                n instanceof c
                  ...
                  : function (t, i) {
                      ...
                      p(i.props, function (t, e) {
                        ...
                        o[s] &&
                          r.inArray(null, o[s].slice(0, 3)) < 0 &&
                          (null == o[s][3] && (o[s][3] = 1),
    ...
    (u.hsla.from = function (t) {
      ...
      var e = t[0] / 360,
        ...
        s = 2 * s - i;
      return [
        Math.round(255 * n(s, i, e + 1 / 3)),
        Math.round(255 * n(s, i, e)),
        Math.round(255 * n(s, i, e - 1 / 3)),
        t,
      ];
    }),
        ...
        p(e, function (a, r) {
          c.fn[a] ||
            (c.fn[a] = function (t) {
              ...
              return "undefined" === i
                ? o
                : ("function" === i && (i = f((t = t.call(this, o)))),
                  null == t && r.empty
                    ? this
                    : ("string" === i &&
                        (e = h.exec(t)) &&
      ...
      function (t, e) {
        V.fx.step[e] = function (t) {
          (("none" !== t.end && !t.setAttr) || (1 === t.pos && !t.setAttr)) &&
            (r.style(t.elem, e, t.end), (t.setAttr = !0));
        };
      }
    ),
    V.fn.addBack ||
      ...
      V.extend(V.effects, {
        save: function (t, e) {
          for (var i = 0, s = e.length; i < s; i++)
            null !== e[i] && t.data(T + e[i], t[0].style[e[i]]);
        },
        restore: function (t, e) {
          for (var i, s = 0, n = e.length; s < n; s++)
            null !== e[s] && ((i = t.data(T + e[s])), t.css(e[s], i));
        },
  ...
  function K(t, e, i) {
    return [
      parseFloat(t[0]) * (j.test(t[0]) ? e / 100 : 1),
      parseFloat(t[1]) * (j.test(t[1]) ? i / 100 : 1),
    ];
  }
  function U(t, e) {
      ...
      return (
        ...
        V.each(["my", "at"], function () {
          ...
          ((i =
            ...
            (u[this] = [B.exec(i[0])[0], B.exec(i[1])[0]]);
        }),
        1 === y.length && (y[1] = y[0]),
        "right" === u.at[0]
          ? (m.left += p)
          ...
          "right" === u.my[0]
            ...
            u.using &&
              (t = function (t) {
                ...
                p < r && F(e + i) < p && (o.horizontal = "center"),
                  f < l && F(s + n) < f && (o.vertical = "middle"),
                  W(F(e), F(i)) > W(F(s), F(n))
